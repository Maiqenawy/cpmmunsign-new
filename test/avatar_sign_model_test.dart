...
void main() {
  group('AvatarSign.fromJson Tests', () {
    ...
    test(
      'should parse flat list landmarks using frames and landmarks_per_frame',
      () {
        final json = {
          "word": "eat",
          "frames": 2,
    ...
    test(
      'should fallback if frames is missing but landmarks_per_frame is present',
      () {
        final json = {
          "word": "eat",
          "landmarks_per_frame": 3,
